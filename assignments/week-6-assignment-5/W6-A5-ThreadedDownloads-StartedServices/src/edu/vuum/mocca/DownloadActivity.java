    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
            ...
            // returned from the makeIntent() factory method.
             intent=DownloadIntentService.makeIntent(getApplicationContext(),handler,DownloadUtils.OFFLINE_FILENAME);
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
            intent=ThreadPoolDownloadService.makeIntent(getApplicationContext(),handler,DownloadUtils.OFFLINE_FILENAME);
