...
public class DownloadIntentService extends IntentService {
    ...
    protected void onHandleIntent (Intent intent) {
        ...
        String pathToFile=DownloadUtils.downloadFile(this.getApplicationContext(), Uri.parse(intent.getDataString()));
        DownloadUtils.sendPath(pathToFile,(Messenger)intent.getExtras().get(DownloadUtils.MESSENGER_KEY));
    }
}
