...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        SimpleSemaphore pingPongSemaOne;
        SimpleSemaphore pingPongSemaTwo;
        /**
        ...
        public PlayPingPongThread(String stringToPrint,
                                  ...
                                  int maxIterations) {
            // TODO - You fill in here.
            pingPongSemaOne=semaphoreOne;
            pingPongSemaTwo=semaphoreTwo;
            pingPongString=stringToPrint;
        ...
        public void run() {
            ...
            for (int i =0;i<mMaxLoopIterations;i++){
                acquire();
                System.out.println(pingPongString);
                release();
            }
            mLatch.countDown();
        }
        ...
        private void acquire()  {
            // TODO fill in here
            System.out.println("aquire"+this.pingPongString);

            try {
                this.pingPongSemaOne.acquire();
        ...
        private void release() {
            // TODO fill in here
            System.out.println("release"+pingPongString);
            this.pingPongSemaTwo.release();
        }
    }
